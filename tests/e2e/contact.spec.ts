...
test.describe('contact form', () => {
  ...
  test('a complete submission is accepted and confirmed', async ({ page }) => {
    ...
    await page.getByLabel('Organisation').fill('Playwright QA')
    await page.getByLabel('E-mail address').fill('qa@example.com')
    await page.getByLabel('Country').selectOption('DE')
    await page.getByLabel('Type of request').selectOption('consulting')
